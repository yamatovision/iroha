...
export class SimplifiedDateTimeProcessor {
  ...
  private static instance: SimplifiedDateTimeProcessor;
  ...
  constructor(timeZoneManager?: SimplifiedTimeZoneManager) {
    this.timeZoneManager = timeZoneManager || SimplifiedTimeZoneManager.getInstance();
  }
   ...
   */
  public static getInstance(): SimplifiedDateTimeProcessor {
   ...
   */
  private createSimpleDateTime(date: Date, hourWithMinutes: number): SimpleDateTime {
