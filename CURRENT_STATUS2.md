...
## チーム機能と友達機能リファクタリング
- [~] 119. Friendshipモデルの新規作成（友達関係管理）
- [~] 120. TeamMembershipモデルの新規作成（多対多関係）
- [~] 121. InvitationLinkモデルの新規作成（招待管理）
- [~] 122. Userモデルとチームメンバーシップ関連の修正
- [~] 123. Teamモデルの拡張（管理者複数対応）
- [ ] 124. 友達サービス層の実装（検索、申請、承認機能）
- [ ] 125. チームサービス層の更新（友達機能との連携）
- [ ] 126. 招待処理サービスの実装
- [ ] 127. 友達リスト画面の実装
- [ ] 128. チームメンバー追加UIの更新（友達から選択機能）
- [ ] 129. チームハブ画面の実装
- [ ] 130. 招待リンク処理フローの実装
- [ ] 131. プラン別チーム作成制限の実装
- [ ] 132. グローバルチームコンテキストの実装（チーム切り替え）
- [ ] 133. チームデータ取得のキャッシュ最適化
- [ ] 134. チーム目標アドバイス機能のUI分離
