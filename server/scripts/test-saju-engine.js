 ...
 */
// Node.jsのrequireシステムを使用してモジュールを読み込む
const path = require('path');
// ESモジュールからCommonJSに変換されたモジュールをrequireする
const { SajuEngine } = require('../../sajuengine_package/dist/index.js');
...
if (result.hiddenStems && result.hiddenStems.month) {
  console.log('\n【月支の蔵干】');
  result.hiddenStems.month.forEach(stem => {
    console.log(stem);
  });
}
