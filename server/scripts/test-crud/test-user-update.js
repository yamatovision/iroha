/**
 * 管理者APIでユーザー権限とプランを更新するテスト
 * get-token.jsで取得したトークンを使用
 */
...
const TEST_ROLE = 'Admin';  // 変更する権限
const TEST_PLAN = 'elite';  // 変更するプラン
...
async function updateUserRole() {
  try {
    console.log(`\nユーザー権限を ${TEST_ROLE} に更新中...`);
    const response = await axios.put(
      `${API_BASE_URL}/admin/admins/${TEST_USER_ID}/role`, 
      { role: TEST_ROLE },
